# Optimizing TinyML with quantization and distillation in Resource-Constrained Environments for EDGE Devices

In this project we try to deploy a feasible adaptation
of state-of-the-art TinyML system for usage
...
ESP32 and Raspberry Pi Pico or cheaper smartphones. The lightweight Vision-Transformer, Vision Language Models and
Mamba versions are designed to fit inside the rigorous 32–64 KB to 2GB(smartphones only)
RAM constraints that are typical of low-cost microcontrollers
using simulated NVFP4 quantization without the Blackwell architecture and information distillation. By providing
accurate on-device accuracy for different application domains with minimal energy and infrastructure
